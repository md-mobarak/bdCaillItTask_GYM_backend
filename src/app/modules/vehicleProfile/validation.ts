import { z } from 'zod';
const   createVehicleProfile = z.object({
    body: z.object({
      ...
      registeration_date: z.string({
        required_error: 'Registration Date is required',
      }).optional(),
      color: z.string({
        required_error: 'Color is required',
      }),
      registeration_validity: z.string({
...
export const vehicleProfileValidation = {
